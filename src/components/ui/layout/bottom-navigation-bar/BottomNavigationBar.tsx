  ...
  return (
    <nav id="bottom-navigation-bar-container">
      <ul id="bottom-navigation-bar">
        <li><NavigationsElement label="Udforsk" iconUrl={udforskIcon} /></li>
        <li><NavigationsElement label="Kort" iconUrl={kortIcon} /></li>
        <li className="add-button-container">
          <button className="add-button">
        <img src={plusIcon} alt="plus icon" className="plus-icon" />
      </button>
        </li>
        <li><NavigationsElement label="Favoritter" iconUrl={favoritterIcon} /></li>
        <li><NavigationsElement label="Profil" iconUrl={profilIcon} /></li>
      </ul>
    </nav>
  );
}
